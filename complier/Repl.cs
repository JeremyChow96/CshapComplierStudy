...
namespace complier
{
    internal abstract class Repl
    {
        ...
        {
            var methods = GetType().GetMethods( BindingFlags.NonPublic
                                               | BindingFlags.Instance
                                               | BindingFlags.FlattenHierarchy
                                               | BindingFlags.Static);
            foreach (var method in methods)
            {
                //var attribute = method.GetCustomAttributesData().SingleOrDefault(cd => cd.AttributeType == typeof(MetaCommandAttribute);
                //if (attribute==null)
                //{
                //    continue;
                //}
                ...
                //    .SingleOrDefault(na => na.MemberName == nameof(MetaCommandAttribute.Name)).TypedValue.Value as string;

                //string description = attribute.NamedArguments
                //    .SingleOrDefault(na => na.MemberName == nameof(MetaCommandAttribute.Description)).TypedValue.Value as string;
        ...
        private sealed class SubmissionView
        {
            ...
            private void UpdateCursorPosition()
            {
                ...
                Console.CursorLeft = 3 + CurrentCharacter;
            }
        ...
        protected virtual void EvaluateMetaCommand(string input)
        {
            ...
            //#load "sample/""hello world""/hello.ms"
