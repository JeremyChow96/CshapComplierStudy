...
namespace complier.CodeAnalysis.Binding
{
    internal sealed class ControlFlowGraph
    {
        ...
        public sealed class GraphBuilder
        {
            ...
            {
                // current block doesn't have any incomings . and then
                // we delete it .
        ...
        public void WriteTo(TextWriter writer)
        {
            ...
            var blcokIds = new Dictionary<BasicBlock, string>();
            for (int i = 0; i < Blocks.Count; i++)
            {
                var id = $"N{i}";
                blcokIds.Add(Blocks[i], id);
            }
            ...
            foreach (var branch in Branches)
            {
                ...
                var fromId = blcokIds[branch.From];
                var toId = blcokIds[branch.To];
        ...
        public static ControlFlowGraph Create(BoundBlockStatement statement)
        {
            ...
            var blocks = basicBlockBuilder.Build(statement);
